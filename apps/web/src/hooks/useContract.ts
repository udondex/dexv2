...
export function useKKUBContract(tokenAddress?: string, withSignerIfPossible?: boolean) {
  return useContract<KkubAbi>(tokenAddress, kkubAbi, withSignerIfPossible)
}

export function useKkubKycContract(tokenAddress?: string, withSignerIfPossible?: boolean) {
  return useContract<KkubKycAbi>(tokenAddress, kkubKycAbi, withSignerIfPossible)
}
