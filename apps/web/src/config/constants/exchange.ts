...
import { bscTokens, bscTestnetTokens, bkcTestnetTokens, USDC, USDT, BUSD, WBTC_ETH } from '@pancakeswap/tokens'
...
export const ROUTER_ADDRESS: ChainMap<string> = {
  ...
  [ChainId.BKC_TESTNET]: '0x6adb785f5e06e4c5e2da3341abb1a92a31ad5d85',
}
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.BKC_TESTNET]: [bkcTestnetTokens.kkub, bkcTestnetTokens.usdt],
}
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.BSC_TESTNET]: [bscTestnetTokens.wbnb, bscTestnetTokens.cake, bscTestnetTokens.busd],
  [ChainId.BKC_TESTNET]: [bkcTestnetTokens.kkub],
}
