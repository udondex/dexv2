...
import { bscTokens, bscTestnetTokens, bkcTokens, USDC, USDT, BUSD, WBTC_ETH } from '@pancakeswap/tokens'
...
export const ROUTER_ADDRESS: ChainMap<string> = {
  ...
  [ChainId.BKC]: '0x7aA32A818cD3a6BcdF827f6a411B7adFF56e7A4A',
}
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.BSC_TESTNET]: [bscTestnetTokens.wbnb, bscTestnetTokens.cake, bscTestnetTokens.busd],
  [ChainId.BKC]: [bkcTokens.kkub, bkcTokens.kusdt, bkcTokens.kusdc],
}
