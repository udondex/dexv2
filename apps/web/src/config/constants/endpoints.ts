...
export const INFO_CLIENT = 'https://api.udonswap.io/subgraphs/name/testnet/exchange-v2'
export const BLOCKS_CLIENT = 'https://api.udonswap.io/subgraphs/name/testnet/blocks'
