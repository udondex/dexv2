...
import { ArrowForwardIcon, LogoWithTextDarkIcon, LogoWithTextIcon } from "../Svg";
    ...
    >
      <Flex flexDirection="column" width={["100%", null, "1200px;"]}>
        <StyledIconMobileContainer display={["block", null, "none"]}>
          <LogoWithTextDarkIcon height="auto" width="100px" />
        </StyledIconMobileContainer>
        <Flex
          order={[2, null, 1]}
        ...
        >
          ...
          <Box display={["none", null, "block"]}>
            <LogoWithTextDarkIcon height="auto" width="120px" />
          </Box>
        </Flex>
